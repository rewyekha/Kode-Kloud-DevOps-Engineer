...
2.  Grant permissions to these users to access `Packages` job as per details mentioned below:
    ...
    c.) Grant mentioned permissions to `rohan` user : `build`, `cancel`, `configure`, `read`, `update` and `tag`.<br>
...
<figure><img src="../.gitbook/assets/Screenshot 2026-05-17 200909.png" alt=""><figcaption></figcaption></figure>
